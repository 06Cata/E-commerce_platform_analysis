    ...
    for csv_file in csv_files:
        ...
        create_table_query = '''
            CREATE TABLE IF NOT EXISTS youtube_data (
                ...
                sentiment_score_original FLOAT
            )
        '''
        ...
        for _, row in df.iterrows():
            insert_query = '''
                INSERT INTO youtube_data (`time`, video_title, `type`, comment, video_id, sentiment_score_translated, translated_comment, sentiment_score_original)
            ...
            cursor.execute(insert_query, (
                ...
                row['comment'],
                row['video_id'],
                row['Sentiment_Score (Translated)'],
                row['Translated_Comment'],
                row['Sentiment_Score (Original)']
            ))
