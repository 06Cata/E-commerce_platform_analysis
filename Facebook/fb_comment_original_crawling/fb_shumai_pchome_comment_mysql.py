...
create_table_query = """
CREATE TABLE IF NOT EXISTS facebook_shumai_pchome (
...
for entry in data:
    ...
    for comment in comments:
        insert_data_query = f"""
        INSERT INTO facebook_shumai_pchome (source, keyword, time, post, comment)
        VALUES ('{source}', '{keyword}', '{time}', '{post}', '{comment}')
        """
