...
create_table_query = """
CREATE TABLE IF NOT EXISTS facebook_shumai_pchome_bert (
...
# Read the JSON file
with open('fb_shumai_pchome_comment_bert.json', 'r', encoding='utf-8') as file:
    data = json.load(file)
...
for entry in data:
    ...
    insert_data_query = f"""
    INSERT INTO facebook_shumai_pchome_bert (source, keyword, comment, time, score)
